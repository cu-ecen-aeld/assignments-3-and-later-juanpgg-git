...
if [ $?  -ne 0 ]
then
    echo "Fail creating directory: ${OUTDIR}"
    exit 0
fi
...
echo "[1] Make and install busybox..."
make ARCH=${ARCH} CROSS_COMPILE=${CROSS_COMPILE}
echo "[2] Make and install busybox..."
make CONFIG_PREFIX=${OUTDIR}/rootfs ARCH=${ARCH} CROSS_COMPILE=${CROSS_COMPILE} install

echo "Read Library dependencies..."
...
echo  "Create the init ramfs cpio..."
